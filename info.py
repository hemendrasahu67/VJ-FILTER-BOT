...
API_ID = int(environ.get('API_ID', '28528007'))
API_HASH = environ.get('API_HASH', '38464da16c80310cabc8d13952419cf3')
BOT_TOKEN = environ.get('BOT_TOKEN', "")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://envs.sh/pmu.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/b69af2db776e4e85d21ec.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/HOW_TO_VERIFY_LINKK")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002080858504'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7525346661').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002208295766').split()] #index chanel automatic
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7525346661').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002328648266') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002299957824')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002328648266')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', '-1002208295766'))
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '843ef9c59c5673a3b9a1caf6a80bff012aa0a7fd')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '843ef9c59c5673a3b9a1caf6a80bff012aa0a7fd')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://diamond-moves-bot2-9dc5de2ef04f.herokuapp.com/")
