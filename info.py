...
API_ID = int(environ.get('API_ID', '28700344'))
API_HASH = environ.get('API_HASH', '7ef39c8ff60df33dc5e55d418fa8b636')
BOT_TOKEN = environ.get('BOT_TOKEN', "7132080391:AAGKBpnaRlErQfgArvGF0XRWR4yzxnZt36E")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://graph.org/file/45b500d14ee50dffa3765.jpg')).split() #SAMPLE PIC
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7131041669').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002055683410').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7131041669').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mh:qFECbQkAflJ4Teqd@cluster0.c64io4v.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moves_hub_request')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/movess_hub')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/movess_hub')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Moves_support1_bot') # Support Chat Link Without https:// or @
